...
# Page configuration
st.set_page_config(page_title="Agent Transactions Summary - ABNK", layout="wide")
st.title("Agent Transactions Summary - ABNK")

# Fetch and process transactions for ABNK
def fetch_transaction_data():
    ...
    #    final_data["Agt"].between("ABNK0000002", "ABNK0000009")
    #]

    return final_data

# Get the summarized data
final_data = fetch_transaction_data()
